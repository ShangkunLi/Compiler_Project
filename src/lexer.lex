...
<INITIAL>">" {yylval.pos = A_Pos(line, col); col+=2; return GT; }
...
<INITIAL>[a-zA-Z]+([a-zA-Z0-9]*) 	{ 
    ...
    new_text[len]='\0';
    yylval.tokenId = A_TokenId(A_Pos(line, col), new_text); col+=yyleng; return TOKENID; 
}
